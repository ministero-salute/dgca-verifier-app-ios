...
class RevocationValidityCheckTests: XCTestCase {
    var hcert: HCert!
    var payload: String!
    ...
    override func setUpWithError() throws {
        ...
        if let _ = realm {} else { realm = try! Realm() }
        
        SettingDataStorage.sharedInstance.settings = []
        
        let VaccineEMASetting = Setting(name: "DRL_SYNC_ACTIVE", type: "GENERIC", value: "true")
    ...
    override func tearDownWithError() throws {
        ...
        DRLDataStorage.removeAll(hashes: nil, isEUDCC: false)
    }
